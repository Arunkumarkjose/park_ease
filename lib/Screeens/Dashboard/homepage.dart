          ...
          Container(
            ...
            child: ListTile(
                ...
                leading: Container(
                  ...
                  child: Icon(FontAwesomeIcons.locationPin, color:Colors.black),
                ),
                title: Text(
                ...
                trailing: Container(
                  ...
                  child: const Icon(FontAwesomeIcons.circleChevronDown, color:Color(0xffffffff)),
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          title: FittedBox(fit: BoxFit.fitWidth, child: Text(name??'')),
